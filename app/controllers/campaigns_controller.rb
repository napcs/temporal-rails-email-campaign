class CampaignsController < ApplicationController
  before_action :set_campaign, only: %i[ show edit update destroy welcome_message unsubscribe_message ]
  ...
  private
    ...
    def campaign_params
      params.require(:campaign).permit(:name, :welcome_message, :unsubscribe_message)
    end
end
